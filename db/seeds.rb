...
Card.create(
    ...
    arcana_id: 1, 
    suit_id: 1
).image_file.attach(io: open('https://tarotproject.s3.us-east-2.amazonaws.com/tarot-fool.jpeg'), url:'https://tarotproject.s3.us-east-2.amazonaws.com/tarot-fool.jpeg', filename: 'tarot-fool.jpeg')
